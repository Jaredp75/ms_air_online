    ...
    return(
      <div>
        ...
        <div className = 'content-area-container'>
          ...
          <p className="terms-para">We use reasonable precautions to keep the personal information you disclose both in your browsing and your purchases. However, we are not responsible for any breach of security.</p>

          <p><b>OBTAINING YOUR CONSENT</b></p>
