        ...
        <div className = 'content-area-container'>
          ...
          <div className="subcategories">
            <div className="subcat_section1">
              ...
              <h2><a href="/subcat=233/grade_p_particulate_bulk_liquid">Grade P - Particulate/Bulk Liquid</a></h2>
            </div>
            ...
            <div className="subcat_section4">
              ...
              <h2><a href="/subcat=233/grade_a_activated_carbon">Grade A - Activated Carbon</a></h2>
            </div>
          </div>
