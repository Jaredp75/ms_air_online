...
export default class prodID1874 extends React.Component {
                ...
                <div className="individual_product_listing">
                  <div className="individual_product_entry">
                    ...
                    <div id="product-image">
                      <img src="https://www.msaironline.com/images/prodImage/1874_144x85.jpg" alt="ZFC Replacement Element"></img>
                      <p>Catalog Number: EC470A</p>
                    </div>
                    ...
                    <h4 className="individual-product-suggested-retail-price">MSRP: $260.00</h4>
                    <h4 className="individual-product-savings">Savings: <strong>$91.00</strong></h4>
                    <h3 className="individual-product-actual-price"><strong>$169.00</strong></h3>
                  </div>
                </div>
            ...
            <div className="replacement_item_listing">
              <div className="replacement_item_entry">
                <div className="replacement_item_image">
                  <img className="filter" src="http://www.msaironline.com/images/prodImage/1810_144x85.jpg" alt="ZFC Compressed Air Filter"></img>
                  <p>Catalog Number: ZFC470A</p>
                </div>
              <div className="replacement_item_details">
                <h6 className="replacement_item_title"><a href="/subcat=233/prodID1810">ZFC Compressed Air Filter</a></h6>
                ...
                <h6 className="individual-product-suggested-retail-price">MSRP: $1,019.00</h6>
                <h6 className="replacement_item_actual_price"><strong>$662.35</strong></h6>
              </div>
            </div>
          </div>
      </div>
