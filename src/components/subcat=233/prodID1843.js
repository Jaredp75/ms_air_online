...
export default class prodID1843 extends React.Component {
                ...
                <div className="individual_product_listing">
                  <div className="individual_product_entry">
                    ...
                    <div className="product-image">
                      <img src="https://www.msaironline.com/images/prodImage/1843_144x85.jpg" alt="ZFC Replacement Element"></img>
                    ...
                    <h4 className="individual-product-suggested-retail-price">MSRP: $56.00</h4>
                    <h4 className="individual-product-savings">Savings: <strong>$19.60</strong></h4>
                    <h3 className="individual-product-actual-price"><strong>$36.40</strong></h3>
                  </div>
                </div>
            ...
            <div className="replacement_item_listing">
              <div className="replacement_item_entry">
                <div className="replacement_item_image">
                  <img className="filter" src="http://www.msaironline.com/images/prodImage/1779_144x85.jpg" alt="ZFC Compressed Air Filter"></img>
                  <p>Catalog Number: ZFC65P</p>
                </div>
              <div className="replacement_item_details">
                <h6 className="replacement_item_title"><a href="/subcat=233/prodID1779">ZFC Compressed Air Filter</a></h6>
                ...
                <h6 className="individual-product-suggested-retail-price">MSRP: $323.00</h6>
                <h6 className="replacement_item_actual_price"><strong>$209.95</strong></h6>
              </div>
            </div>
          </div>
      </div>
