...
export default class prodID1842 extends React.Component {
                ...
                <div className="individual_product_listing">
                  <div className="individual_product_entry">
                    ...
                    <div id="product-image">
                      <img src="https://www.msaironline.com/images/prodImage/1842_144x85.jpg" alt="ZFC Replacement Element"></img>
                      <p>Catalog Number: EC45A</p>
                    </div>
            ...
            <div className="replacement_item_listing">
              <div className="replacement_item_entry">
                <div className="replacement_item_image">
                  <img className="filter" src="http://www.msaironline.com/images/prodImage/1778_144x85.jpg" alt="ZFC Compressed Air Filter"></img>
                  <p>Catalog Number: ZFC45A</p>
                </div>
              <div className="replacement_item_details">
                <h6 className="replacement_item_title"><a href="/subcat=233/prodID1778">ZFC Compressed Air Filter</a></h6>
                ...
                <h6 className="individual-product-suggested-retail-price">MSRP: $261.00</h6>
                <h6 className="replacement_item_actual_price"><strong>$169.65</strong></h6>
              </div>
            </div>
          </div>
      </div>
