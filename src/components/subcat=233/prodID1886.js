...
export default class prodID1886 extends React.Component {
                ...
                <div className="individual_product_listing">
                  <div className="individual_product_entry">
                    ...
                    <div id="product-image">
                      <img src="https://www.msaironline.com/images/prodImage/1886_144x85.jpg" alt="ZFC Replacement Element"></img>
                      <p>Catalog Number: EC920A</p>
                    </div>
                    ...
                    <h4 className="individual-product-suggested-retail-price">MSRP: $341.00</h4>
                    <h4 className="individual-product-savings">Savings: <strong>$119.35</strong></h4>
                    <h3 className="individual-product-actual-price"><strong>$221.65</strong></h3>
                  </div>
                </div>
            ...
            <div className="replacement_item_listing">
              <div className="replacement_item_entry">
                <div className="replacement_item_image">
                  <img className="filter" src="http://www.msaironline.com/images/prodImage/1822_144x85.jpg" alt="ZFC Compressed Air Filter"></img>
                  <p>Catalog Number: ZFC920A</p>
                </div>
              <div className="replacement_item_details">
                <h6 className="replacement_item_title"><a href="/subcat=233/prodID1822">ZFC Compressed Air Filter</a></h6>
                ...
                <h6 className="individual-product-suggested-retail-price">MSRP: $1,653.00</h6>
                <h6 className="replacement_item_actual_price"><strong>$1,074.45</strong></h6>
              </div>
            </div>
          </div>
      </div>
