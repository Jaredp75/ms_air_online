...
export default class prodID1844 extends React.Component {
                ...
                <div className="individual_product_listing">
                  <div className="individual_product_entry">
                    ...
                    <div id="product-image">
                      <img src="https://www.msaironline.com/images/prodImage/1844_144x85.jpg" alt="ZFC Replacement Element"></img>
            ...
            <div className="replacement_item_listing">
              <div className="replacement_item_entry">
                <div className="replacement_item_image">
                  <img className="filter" src="http://www.msaironline.com/images/prodImage/1780_144x85.jpg" alt="ZFC Compressed Air Filter"></img>
                  <p>Catalog Number: ZFC65G</p>
                </div>
              <div className="replacement_item_details">
                <h6 className="replacement_item_title"><a href="/subcat=233/prodID1780">ZFC Compressed Air Filter</a></h6>
