...
export default class prodID1832 extends React.Component {
            ...
            <div className="replacement_item_listing">
              <div className="replacement_item_entry">
                <div className="replacement_item_image">
                  <img className="filter" src="http://www.msaironline.com/images/prodImage/1896_144x85.jpg" alt="ZFC Replacement Element"></img>
                  <p>Catalog Number: EC1600G</p>
                </div>
              <div className="replacement_item_details">
                <h6 className="replacement_item_title"><a href="/subcat=233/prodID1896">ZFC Replacement Element</a></h6>
