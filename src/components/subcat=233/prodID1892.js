...
class prodID1892 extends Component {
  constructor() {
    super();
    this.state = {
      products: [],
  ...
  componentDidMount() {
    ...
    fetch('https://www.msaironline.com/qa1/api/product.php?id=1892')
    .then(results => {
      return results.json();
    }).then(data => {
...
<div className="replacement_parts_section">
      ...
      <span className="replacement_parts_detail">
        <div className="replacement_parts_thumbnail">
          <img src="http://www.msaironline.com/images/prodImage/1828_144x85.jpg" alt="ZFC Compressed Air Filter"></img>
        </div>

        <h4 className="replacement_parts_name"><a href="/subcat=233/prodID1828">ZFC Compressed Air Filter</a></h4>
