  ...
  setCart(data){
	  ...
	  var subtotal = null
		  if(data.summary[0].discount > 0)
			  discount = (<div>Discount: {data.summary[0].discount} </div>)
		  if(data.summary[0].order_min > 0)
			  min_order_fee = (<div>Min Order Fee: {data.summary[0].order_min} </div>)
		  ...
		  totals = (
					<div>
						...
						{tax}
						{shipping}
						<div>Total: {data.summary[0].order_due}</div>
					</div>
			  )
        ...
        <div className = 'content-area-container'>
          ...
          <div className="replacement_parts_header">
            <h1>Billing Information</h1>
			  ...
			  <fieldset>        <div className="form-group col-md-6">
                ...
                <div className="form-row">
                  <div className="form-group col-md-4">
                    <label className="inputPhone"><strong>* Phone</strong></label>
                      <input readonly='readonly' name="phone" type="text" className="form-control"  id="inputPhone" value={this.state.phone} pattern="[0-9]{3}" />
                  </div>
                </div></fieldset>
            ...
            <div className="replacement_parts_header">
              ...
              <fieldset>
                ...
                <div className="form-row">
                  <div className="form-group col-md-4">
                    <label className="inputPhone"><strong>Phone</strong></label>
                      <input name="phone" readonly='readonly' type="text" className="form-control" id="inputPhone" value={this.state.sphone} />
                  </div>
                </div>
