    ...
    return(
      <div className="home-brands">
        ...
        <div className = 'content-area-container'>
          ...
          <div className="home-header"><h4>Having trouble locating a part? Contact us using our web submission form <a href="../contact_us">here</a>. Or call <strong>1-877-MSAIR99</strong>.</h4></div>
