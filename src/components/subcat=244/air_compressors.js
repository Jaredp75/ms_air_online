...
export default class Air_Compressors extends React.Component {
              ...
              <div className="individual-product">
                <div className="individual_product_listing">
                  <div className="individual_product_entry">
                    ...
                    <h4 className="individual-product-suggested-retail-price">MSRP: $21665.70</h4>
                    <h4 className="individual-product-savings">Savings: <strong>$8,995.70</strong></h4>
                    <h3 className="individual-product-actual-price"><strong>12670.00</strong></h3>
                  </div>
                </div>
    ...
    <div className="individual-product">
      <div className="individual_product_listing">
        <div className="individual_product_entry">
          ...
          <div className="individual-product-details">
            <h2 className="individual-product-title">75HP Air Compressor</h2>
            <h4 className="product-brand-title">Trident</h4>
          ...
          <div className="individual-product-description">
            ...
            <h4 className="individual-product-suggested-retail-price">MSRP: $49489.30</h4>
            <h4 className="individual-product-savings">Savings: <strong>$</strong></h4>
            <h3 className="individual-product-actual-price"><strong>28941.11</strong></h3>
        </div>
      </div>
    ...
    <div className="individual-product">
      <div className="individual_product_listing">
        <div className="individual_product_entry">
          ...
          <div className="individual-product-details">
            <h2 className="individual-product-title">60HP Air Compressor</h2>
            <h4 className="product-brand-title">Sullivan-Palatek</h4>
          ...
          <div className="individual-product-description">
            ...
            <h4 className="individual-product-suggested-retail-price">MSRP: $45638.00</h4>
            <h4 className="individual-product-savings">Savings: <strong>$</strong></h4>
            <h3 className="individual-product-actual-price"><strong>26688.89</strong></h3>
        </div>
      </div>
      ...
      <div className="individual_product_listing">
        <div className="individual_product_entry">
          ...
          <div className="individual-product-description">
            ...
            <h4 className="individual-product-suggested-retail-price">MSRP: $35165.20</h4>
            <h4 className="individual-product-savings">Savings: <strong>$</strong></h4>
            <h3 className="individual-product-actual-price"><strong>20564.44</strong></h3>
        </div>
      </div>
    ...
    <div className="individual-product">
      <div className="individual_product_listing">
        <div className="individual_product_entry">
          ...
          <div className="individual-product-details">
            <h2 className="individual-product-title">40HP Air Compressor</h2>
            <h4 className="product-brand-title">Sullivan-Palatek</h4>
          ...
          <div className="individual-product-description">
            ...
            <h4 className="individual-product-suggested-retail-price">MSRP: $29497.50</h4>
            <h4 className="individual-product-savings">Savings: <strong>$</strong></h4>
            <h3 className="individual-product-actual-price"><strong>17250.00</strong></h3>
        </div>
      </div>
    ...
    <div className="individual-product">
      <div className="individual_product_listing">
        <div className="individual_product_entry">
          ...
          <div className="individual-product-details">
            <h2 className="individual-product-title">30HP Air Compressor</h2>
            <h4 className="product-brand-title">Sullivan-Palatek</h4>
      ...
      <div className="individual_product_listing">
        <div className="individual_product_entry">
          ...
          <div className="individual-product-description">
            ...
            <h4 className="individual-product-suggested-retail-price">MSRP: $25536.00</h4>
            <h4 className="individual-product-savings">Savings: <strong>$</strong></h4>
            <h3 className="individual-product-actual-price"><strong>14933.33</strong></h3>
        </div>
      </div>
    ...
    <div className="individual-product">
      <div className="individual_product_listing">
        <div className="individual_product_entry">
          ...
          <div className="individual-product-details">
            <h2 className="individual-product-title">20HP Air Compressor</h2>
            <h4 className="product-brand-title">Sullivan-Palatek</h4>
    ...
    <div className="individual-product">
      <div className="individual_product_listing">
        <div className="individual_product_entry">
          ...
          <div className="individual-product-details">
            <h2 className="individual-product-title">125HP Air Compressor</h2>
            <h4 className="product-brand-title">Sullivan-Palatek</h4>
          ...
          <div className="individual-product-description">
            ...
            <h4 className="individual-product-suggested-retail-price">MSRP: $80465.00</h4>
            <h4 className="individual-product-savings">Savings: <strong>$</strong></h4>
            <h3 className="individual-product-actual-price"><strong>47055.56</strong></h3>
        </div>
      </div>
