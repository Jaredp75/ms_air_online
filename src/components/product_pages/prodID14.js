...
class prodID14 extends Component {
  constructor() {
    super();
    this.state = {
      products: [],
  ...
  componentDidMount() {
    ...
    fetch('https://www.msaironline.com/qa1/api/product.php?id=14')
    .then(results => {
      return results.json();
    }).then(data => {
                  ...
                  <div className="individual-product">
                    ...
                    <div className="individual_product_listing">
                      ...
                      <div id="product-image">
                        <img src={pic.icon} alt="Quick Connect 500 Oxygen Wall Outlet" />
