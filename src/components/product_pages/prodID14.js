...
export default class prodID14 extends React.Component {
  ...
  render(){
    ...
    return(
      ...
      <div className="replacement_item_listing">
        <div className="replacement_item_entry">
          <div className="replacement_item_image">
            <img src="http://www.msaironline.com/images/prodImage/8_144x85.jpg" width="144" height="85" alt="Quick Connect 500 Vacuum Wall Outlet"></img>
          </div>
      ...
      <div className="replacement_item_listing">
        <div className="replacement_item_entry">
          <div className="replacement_item_image">
            <img src="http://www.msaironline.com/images/prodImage/281_144x85.jpg" width="144" height="85" alt="Quick Connect 500 Oxygen Completion Kit"></img>
          </div>
          <div className="replacement_item_details">
      ...
      <div className="replacement_item_listing">
        <div className="replacement_item_entry">
          <div className="replacement_item_image">
            <img src="http://www.msaironline.com/images/prodImage/282_144x85.jpg" width="144" height="85" alt="Quick Connect 500 Rough In Kit - Oxygen"></img>
          </div>
          <div className="replacement_item_details">
      ...
      <div className="replacement_item_listing">
        <div className="replacement_item_entry">
          <div className="replacement_item_image">
            <img src="http://www.msaironline.com/images/prodImage/293_144x85.jpg" width="144" height="85" alt="Quick Connect 500 Oxygen Wall Outlet w/ New Style Cover Plate"></img>
          </div>
          <div className="replacement_item_details">
