...
export default class prodID1469 extends React.Component {
        ...
        <div className="content-area-container2">
          ...
          <div className="individual-product">
            ...
            <div id="product-image">
              <img src="https://www.msaironline.com/images/prodImage/1469_144x85.jpg" alt="Bison Service Filter Set"></img>
              <p>Catalog Number: 003750</p>
            </div>


            <div className="individual-product-details">
              <h2 className="individual-product-title">Bison Service Filter Set</h2>
              <h4 className="product-brand-title">Ramvac</h4>
              <h4 className="individual-product-suggested-retail-price">MSRP: $240.00</h4>
              <h4 className="individual-product-savings">Savings: <strong>$55.20</strong></h4>
              <h3 className="individual-product-actual-price"><strong>$184.80</strong></h3>
              <div className="individual-product-description">
                <ul>
                  ...
                  {/* <br /> */}
                  <li>Includes main air, vac control and oil filter elements<br />for Bison Dental Vacuum.</li>
                  {/* <br /> */}
                  {/* <p>Features:</p> */}
