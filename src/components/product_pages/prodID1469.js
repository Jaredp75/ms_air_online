...
class prodID1469 extends Component {
  constructor() {
    super();
    this.state = {
      products: [],
  ...
  componentDidMount() {
    ...
    fetch('https://www.msaironline.com/qa1/api/product.php?id=1469')
    .then(results => {
      return results.json();
    }).then(data => {
                  ...
                  <div className="individual-product">
                    ...
                    <div className="individual-product-details">
                      <div className="product-title">
                        ...
                        <h4 className="individual-product-suggested-retail-price" type="number">MSRP: ${pic.msrp}</h4>
                    ...
                    <div className="file_section">
                      <a href="http://www.msaironline.com/files/53.pdf"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf-placeholder"></img></a>
                      <a href="http://www.msaironline.com/files/53.pdf"><h5>Bison Filter Maintenance.pdf</h5></a>
                    </div>
