...
class prodID1476 extends Component {
  constructor() {
    super();
    this.state = {
      products: [],
  ...
  componentDidMount() {
    ...
    fetch('https://www.msaironline.com/qa1/api/product.php?id=1476')
    .then(results => {
      return results.json();
    }).then(data => {
...
<div id="replacement_items_section">
        ...
        <img src="http://www.msaironline.com/images/brandImage/9_110x85.jpg" alt="logo-placeholder"></img>
