...
export default class prodID1476 extends React.Component {
        ...
        <div className="content-area-container">
          ...
          <div className="individual-product">
            ...
            <div className="product-image">
              <img src="https://www.msaironline.com/images/prodImage/1476_144x85.jpg" alt="Hg5-Amalgam Separator"></img>
              <p>Catalog Number: Hg5-001</p>
            </div>


            <div className="individual-product-details">
              <h2 className="individual-product-title">Hg5-Amalgam Separator</h2>
              <h4 className="product-brand-title">Solmetex</h4>
    ...
    <div className="replacement_parts_section">
      ...
      <span className="replacement_parts_detail">
        <div className="replacement_parts_thumbnail">
          <img src="http://www.msaironline.com/images/prodImage/1480_144x85.jpg" alt="Recycle Kit"></img>
        </div>
