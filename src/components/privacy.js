        ...
        <div className = 'content-area-container'>
          ...
          <div className="privacy-para"><p>We are committed to protecting your privacy at MS Air Inc. We will not collect any personal information from you that you do not volunteer, and we are the sole owner of all information collected on this site. We do not sell, share, or rent this information to others in any way that we have not mentioned in this statement.</p>
            ...
            <h3><strong>Log Files</strong></h3>
              ...
              <p>Be aware that when you volunteer information or create a public profile in the course of your participation in our community features such as forums, user opinions and reviews, chat rooms, photo sharing or other forms of public communication and interaction, you are also agreeing to allow certain aspects of your personally identifiable information to be made public. This includes your screen name, any address or personal information or images that you add to your signature or otherwise post to the public, and any content of any such post.</p>

            <h3><strong>Links</strong></h3>
              <p>This website contains links to other sites. Please be aware that MSAirOnline.com is not responsible for the privacy practices of such other sites. We encourage our users to be aware when they leave our site and to read the privacy statements of each and every website that collects personally identifiable information. This privacy statement applies only to information collected by this website.</p>

            <h3><strong>Security</strong></h3>
              <p>MSAirOnline.com takes precautions to protect its customers' information. When you submit personal information via the website, we follow policies and procedures designed to protect your information both online and offline, examples of which are as described below.</p>

              <p>When our registration/order form asks you to enter personal information (such as your credit card number), that information is encrypted and is protected with the best encryption software currently available in the industry, SSL.</p>

            <h3><strong>Updating Personal Information</strong></h3>
              <p>Customers may change or review their stored account information such as street address or e-mail address through our website by visiting our My Stuff section. You must have your username and password in order to access your account. In the event you forget both your username and password, please contact our customer service department for assistance.</p>
