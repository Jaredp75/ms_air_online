...
class prodID1707 extends Component {
  constructor() {
    super();
    this.state = {
      products: [],
  ...
  componentDidMount() {
    ...
    fetch('https://www.msaironline.com/qa1/api/product.php?id=1707')
    .then(results => {
      return results.json();
    }).then(data => {
                ...
                <div id="individual_product_page">
                  <div className="individual-product">
                    ...
                    <div className="file_section">
                      ...
                      <br />
                      <a href="http://www.msaironline.com/files/29.pdf"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf-placeholder"></img></a>
                      <a href="http://www.msaironline.com/files/29.pdf"><h5>Dryspell Plus 20 Fact Sheet R1.pdf</h5></a>
                    </div>
