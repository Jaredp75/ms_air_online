...
export default class prodID1712 extends React.Component {
                    ...
                    <div className="trident_fliers">
                      <h6><strong>Files</strong>:</h6>
                        <div className="flier_name"><a href="http://www.msaironline.com/files/26.pdf" target="_blank" rel="noopener noreferrer"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf"></img></a></div>
                          ...
                          <br />
                        <div className="flier_name"><a href="http://www.msaironline.com/files/34.pdf" target="_blank" rel="noopener noreferrer"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf"></img></a></div>
                          <h6><a href="http://www.msaironline.com/files/34.pdf" target="_blank" rel="noopener noreferrer">Dryspell Plus 125 Fact Sheet R1</a></h6>
                    </div>
                  </div>
                </div>
