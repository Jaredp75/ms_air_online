                    ...
                    <div className="trident_fliers">
                      <h6><strong>Files</strong>:</h6>
                        <div className="flier_name"><a href="http://www.msaironline.com/files/26.pdf" target="_blank" rel="noopener noreferrer"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf"></img></a></div>
                          ...
                          <br />
                        <div className="flier_name"><a href="http://www.msaironline.com/files/38.pdf" target="_blank" rel="noopener noreferrer"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf"></img></a></div>
                          <h6><a href="http://www.msaironline.com/files/38.pdf" target="_blank" rel="noopener noreferrer">Dryspell Plus 375 Fact Sheet R1</a></h6>
                    </div>
                  </div>
                </div>
          ...
          <div id="replacement_items_section">
            ...
            <div className="replacement_item_listing">
              <div className="replacement_item_entry">
                ...
                <div className="replacement_item_details">
                  <h6 className="replacement_item_title"><a href="../product_pages/prodID8">350 SCFM Particulate Filter</a></h6>
            ...
            <div className="replacement_item_listing">
              <div className="replacement_item_entry">
                ...
                <div className="replacement_item_details">
                  <h6 className="replacement_item_title"><a href="../product_pages/prodID8">350 SCFM Coalescing Filter</a></h6>
                  <h6 className="replacement_item_brand_name">Trident</h6>
                  <h6 className="replacement_item_actual_price"><strong>$430.18</strong></h6>
                </div>
              </div>
