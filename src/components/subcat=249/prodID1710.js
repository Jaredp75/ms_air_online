...
class prodID1710 extends Component {
  constructor() {
    super();
    this.state = {
      products: [],
  ...
  componentDidMount() {
    ...
    fetch('https://www.msaironline.com/qa1/api/product.php?id=1710')
    .then(results => {
      return results.json();
    }).then(data => {
                ...
                <div id="individual_product_page">
                  <div className="individual-product">
                    ...
                    <div className="file_section">
                      ...
                      <br />
                      <a href="http://www.msaironline.com/files/32.pdf"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf-placeholder"></img></a>
                      <a href="http://www.msaironline.com/files/32.pdf"><h5>Dryspell Plus 60 Fact Sheet R1.pdf</h5></a>
                    </div>
