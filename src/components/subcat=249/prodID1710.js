...
export default class prodID1710 extends React.Component {
                ...
                <div className="individual_product_listing">
                  <div className="individual_product_entry">
                    ...
                    <div className="individual-product-details">
                      <h2 className="individual-product-title">Dryspell 60A</h2>
                    ...
                    <div className="individual-product-description">
                      <ul>
                        ...
                        <li><strong>Flow</strong>: 60 scfm</li>
                    ...
                    <div className="trident_fliers">
                      <h6><strong>Files</strong>:</h6>
                        <div className="flier_name"><a href="http://www.msaironline.com/files/26.pdf" target="_blank" rel="noopener noreferrer"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf"></img></a></div>
                          ...
                          <br />
                        <div className="flier_name"><a href="http://www.msaironline.com/files/32.pdf" target="_blank" rel="noopener noreferrer"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf"></img></a></div>
                          <h6><a href="http://www.msaironline.com/files/32.pdf" target="_blank" rel="noopener noreferrer">Dryspell Plus 60 Fact Sheet R1</a></h6>
                    </div>
