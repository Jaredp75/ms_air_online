...
class prodID1711 extends Component {
  constructor() {
    super();
    this.state = {
      products: [],
  ...
  componentDidMount() {
    ...
    fetch('https://www.msaironline.com/qa1/api/product.php?id=1711')
    .then(results => {
      return results.json();
    }).then(data => {
                ...
                <div id="individual_product_page">
                  <div className="individual-product">
                    ...
                    <div className="file_section">
                      ...
                      <br />
                      <a href="http://www.msaironline.com/files/33.pdf"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf-placeholder"></img></a>
                      <a href="http://www.msaironline.com/files/33.pdf"><h5>Dryspell Plus 100 Fact Sheet R1.pdf</h5></a>
                    </div>
...
<div className="replacement_parts_section">
      ...
      <span className="replacement_parts_detail">
        ...
        <h4 className="replacement_parts_name"><a href="/subcat=251/prodID1703">150 SCFM Particulate Filter</a></h4>
      ...
      <span className="replacement_parts_detail">
        ...
        <h4 className="replacement_parts_name"><a href="/subcat=251/prodID1719">150 SCFM Coalescing Filter</a></h4>
