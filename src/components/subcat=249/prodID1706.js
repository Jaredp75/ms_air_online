...
class prodID1706 extends Component {
  constructor() {
    super();
    this.state = {
      products: [],
  ...
  componentDidMount() {
    ...
    fetch('https://www.msaironline.com/qa1/api/product.php?id=1706')
    .then(results => {
      return results.json();
    }).then(data => {
                ...
                <div id="individual_product_page">
                  <div className="individual-product">
                    ...
                    <div className="file_section">
                      ...
                      <br />
                      <a href="http://www.msaironline.com/files/28.pdf"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf-placeholder"></img></a>
                      <a href="http://www.msaironline.com/files/28.pdf"><h5>Dryspell Plus 10 Fact Sheet.pdf</h5></a>
                    </div>
