...
export default class prodID1706 extends React.Component {
                ...
                <div className="individual_product_listing">
                  <div className="individual_product_entry">
                    ...
                    <div className="individual-product-details">
                      <h2 className="individual-product-title">Dryspell 10A</h2>
                    ...
                    <div className="individual-product-description">
                      <ul>
                        ...
                        <li><strong>Flow</strong>: 10 scfm</li>
                    ...
                    <div className="trident_fliers">
                      ...
                      <br />
                      <div className="flier_name"><a href="http://www.msaironline.com/files/28.pdf" target="_blank" rel="noopener noreferrer"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf"></img></a></div>
                      <h6><a href="http://www.msaironline.com/files/28.pdf" target="_blank" rel="noopener noreferrer">Dryspell Plus 10 Fact Sheet</a></h6>
                    </div>
