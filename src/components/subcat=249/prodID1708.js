...
export default class prodID1708 extends React.Component {
                ...
                <div className="individual_product_listing">
                  <div className="individual_product_entry">
                    ...
                    <div className="trident_fliers">
                      ...
                      <br />
                      <div className="flier_name"><a href="http://www.msaironline.com/files/30.pdf" target="_blank" rel="noopener noreferrer"><img src="http://www.msaironline.com/images/pdf.jpg" alt="pdf"></img></a></div>
                      <h6><a href="http://www.msaironline.com/files/30.pdf" target="_blank" rel="noopener noreferrer">Dryspell Plus 30 Fact Sheet R1</a></h6>
                    </div>
                    </div>
                  </div>
